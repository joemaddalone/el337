...
coverImage: "https://img.youtube.com/vi/PlgAXsy0b3g/maxresdefault.jpg"
coverImageInPost: false
---
export const videoMetadata = {
  name: "Access Apple's Built-in LLM from Terminal with Apfel (Mac Foundation Models)",
  description: "Apple ships a small local language model with macOS Tahoe, and Apfel lets you access it directly from the terminal. In this video, I explore Apple's Foundation Models Framework through the Apfel CLI to see what on-device AI is actually capable of on Apple Silicon.",
  thumbnailUrl: "https://img.youtube.com/vi/PlgAXsy0b3g/maxresdefault.jpg",
  uploadDate: "2026-06-18T00:00:00.000Z",
  contentUrl: "https://youtu.be/PlgAXsy0b3g",
};
