...
import ManFromEarth from '../../../../public/assets/films/13363-The-Man-from-Earth/data.json';
...
<div class="mt-6">
	...
	<div class="max-w-sm mx-auto">
		<FilmWidget filmData={ManFromEarth} posterPath={`/assets/films/13363-The-Man-from-Earth/poster.jpg`} />
	</div>
</div>
...
<div class="flex align-center fluid image justify-center m-3">
