...
If you get a _port already in use_ error, this is common on Linux immediately after installation. It's already running.
...
const input_documents = [
  new Document({
    pageContent: "The color of the house at 6353 Juan Tabo Blvd is blue",
  }),
];
...
const docs = [
  new Document({
    pageContent: "Houses on Juan Tabo Blvd are either red or blue",
  }),
  new Document({
    pageContent: "0 through 9999 are valid addresses on Juan Tabo Blvd",
  }),
  new Document({
    pageContent: "Houses on Juan Tabo Blvd with odd numbered addresses are red",
  }),
];
const res = await chain.call({ input_documents, question });
