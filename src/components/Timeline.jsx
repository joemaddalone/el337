                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {/* Date */}
                        <div className="text-sm font-medium text-blue-200 dark:text-blue-400 mb-2">
                        ...
                        {entry.url && (
                          <a
                            ...
                            className="inline-block mt-3 text-blue-400 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm font-medium transition-colors"
