      ...
      <div className="relative group cursor-pointer overflow-hidden">
        ...
        {filmData.overview && (
          <a
            ...
            className="block"
          >
            <div className="absolute inset-0 bg-black/60 bg-opacity-90 p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
              <p className="text-sm leading-relaxed text-center text-white text-shadow-lg/30">
                {filmData.overview}
              </p>
            </div>
          </a>
